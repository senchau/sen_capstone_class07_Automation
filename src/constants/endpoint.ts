...
export const API_ENDPOINT = "https://movie0706.cybersoft.edu.vn/api";

export const SIGN_IN_PAGE_DOMAIN = `${HOME_PAGE_DOMAIN}/sign-in`;
export const SIGN_UP_PAGE_DOMAIN = `${HOME_PAGE_DOMAIN}/sign-up`;
